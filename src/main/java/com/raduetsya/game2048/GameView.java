    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (model.getGameState() != GameGrid.GAMESTATE.PLAY) {
            ...
            if (animFadeGameover > 10) {
                ...
                canvas.drawText("Score: " + model.getScore(), mainRect.centerX(), mainRect.centerY()+fontHeight*3, resultPaint);
                if (model.getScore() > model.getHighscore()) {
                    canvas.drawText("New record!", mainRect.centerX(), mainRect.centerY()+fontHeight*30, resultPaint);
                    canvas.drawText("Last record: " + model.getHighscore(), mainRect.centerX(), mainRect.centerY()+fontHeight*30, resultPaint);
                } else {
                    canvas.drawText("Highscore: " + model.getHighscore(), mainRect.centerX(), mainRect.centerY()+fontHeight*30, resultPaint);
                }
            }
        } else {
            animFadeGameover = 0;
        ...
        resultPaint.getTextBounds("A", 0, 1, resultRect);
        int fontHeight = (int)(resultRect.height()*1.5);
        canvas.drawText("Score: " + model.getScore(), 100, 3+fontHeight*1, resultPaint);
        canvas.drawText("Highscore: " + model.getHighscore(), 100, 3+fontHeight*2, resultPaint);
